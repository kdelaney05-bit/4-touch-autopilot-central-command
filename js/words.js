...
export const MAP = [
  ...
  { key: 'paperwork', seat: 'sold_office', machine: ['Waives the NOC and permit signature where no permit is needed (Palm Coast)', 'The last upload makes the paperwork official — nobody marks it by hand; PERMIT opens on Sam then', 'Releases the material the moment the paperwork is official (custom or aluminum: once the deposit is in)'], person: ['Records the notarized NOC at the Clerk when the rep’s photo lands; uploads what only she has: the HOA approval, the survey'], customer: 'Signs the notary forms with the rep, or at any notary with a picture back — the machine reminds them' },
