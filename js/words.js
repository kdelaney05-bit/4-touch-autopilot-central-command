...
export const MAP = [
  ...
  { key: 'paperwork', seat: 'sold_office', machine: ['Fills the town\'s forms on the lines and stamps them with the signature — the hold harmless and the permit application are signed on the link, every county', 'The signed contract opens PERMIT on Sam and MATERIAL on Jonathan the same minute — nothing waits on paperwork', 'Waives the NOC and permit signature where no permit is needed (Palm Coast)', 'Reminds the rep about the NOC on days 2, 5, 9, 14, 21 and 30 until it is on the file'], person: ['Pulls the permit off the stamped forms; records the NOC at the Clerk when the rep uploads it; uploads what only she has: the HOA approval, the survey'], customer: 'Signs everything once on the link. The NOC is the rep\'s to get notarized; the customer signs it when the rep brings it' },
