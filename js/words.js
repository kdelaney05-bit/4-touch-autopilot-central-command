...
export const MAP = [
  ...
  { key: 'paperwork', seat: 'sold_office', machine: ['Waives the NOC and permit signature where no permit is needed (Palm Coast)', 'The last upload makes the paperwork official — nobody marks it by hand; the permit never waits on the NOC', 'Releases the material the moment the paperwork is official (custom or aluminum: once the deposit is in)'], person: ['Records the customer’s notarized NOC at the Clerk when the picture lands; uploads what only she has: the HOA approval, the survey'], customer: 'Signs the NOC in front of a notary and sends the picture from the link — the machine reminds them' },
