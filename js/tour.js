...
import { $, html, raw, esc } from './ui.js?v=103';
...
const NOC_STEPS = [
  { room: 'files', at: null, title: 'The customer signs everything, once.', body: 'One link. The proposal, our contract sheet, the disclosures, the hold harmless and the permit application, all under one signature. That acceptance is the contract: they are locked in. Oasis signs the contract alone. The close is one line: great, I can get you started now, go ahead and accept here, and we get everything moving on our end.' },
  { room: 'files', at: '#drawer [data-tour="paperwork"]', do: 'peek:cj7', title: 'The county wants two of them notarized.', body: 'The Notice of Commencement and the Hold Harmless. Florida wants the owner to sign those in front of a notary, and the county will not issue the permit without the hold harmless when the fence is in an easement. So the file fills them in on the town\'s own lines the moment they sign, and emails them to the customer: you are in, your order is moving, here are the two forms.' },
  { room: 'files', at: '#drawer [data-tour="paperwork"] .next', title: 'The rep goes back once, as the notary.', body: 'Eric and Travis are notaries. The SIGNED email carries the packet, printed from the truck: sign here, stamp it, photograph it onto the file. Or the customer takes the forms to any bank and sends a picture from the link. Either way the photo is what pulls the permit.' },
  { room: 'files', at: null, title: 'The machine bugs them. Not you.', body: 'A text from the main line the day they sign: reply with a time for the rep, or any notary and a picture. Then day three, day seven, two weeks, three weeks. Roofing gets it harder, and the rep is pushed to call. The customer knows the only thing that can slow the job is the forms sitting on the counter.', link: 'sign-everything.html', linkText: 'See the customer\'s phone' },
  { room: 'files', at: '#drawer [data-tour="paperwork"]', title: 'The photos close it.', body: 'The stamped pages land on the file, the NOC ask settles, the texts stop, and the last piece of paperwork opens the permit on Sam and the material on Jonathan. Luis already knows it is coming.' },
