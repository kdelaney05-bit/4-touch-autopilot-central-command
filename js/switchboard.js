...
import { state, isDemo, personName, firstName, seatName, directThread, sendDirect, directSeen, searchPeople, searchCustomers, loadFile, threadForJob, postMessage, textCustomer, cancelText, linePreview, mentionHandle, threadReceipts, receiptWords, offerNextWord, NEXT_WORD_FOR_QUESTION } from './book.js?v=72';
import { toast, openModal } from './ui.js?v=72';
import { quotesQueueCard, wireQuotes } from './quotes.js?v=72';
import { crewsCard, wireCrews } from './crews.js?v=72';
import { html, raw, esc } from './ui.js?v=72';
import { brandName, askLabel, stageLabel, STAGES } from './config.js?v=72';
import { renderRoom, wireAtOn } from './village.js?v=72';
