...
const PIPE = [
  ...
  pj('p11', 'Nakamura, Ken', 'Melbourne', 'r3', 150, { cc: '1563' }), pj('p12', 'Whitaker, Ann', 'Palm Bay', 'r2', 200, { lost: true }), pj('p13', 'Grant, Tyrell', 'Deltona', 'r5', null), pj('p14', 'Ivey, Paula', 'Orlando', 'r4', null, { cc: '1560' }), pj('p15', 'Okonkwo, Grace', 'Mims', 'r3', (now - NEXT_MON_9) / 3600e3, { title: 'chain link quote needed' }), pj('p16', 'Ruiz, Carla', 'Titusville', 'r3', (now - NEXT_MON_9) / 3600e3 - 4, { title: 'aluminum pool fence' }),
...
function book() {
  ...
  return { me: { ...me, manages_company_id: null }, seats: SEATS, people, stageSeats: [{ cc_company_id: '1461', stage: 'sold_office', owner_id: 'sam', watcher_id: 'jc' }, { cc_company_id: '1461', stage: 'schedule', owner_id: 'jon', watcher_id: 'jc' }, { cc_company_id: '1461', stage: 'production', owner_id: null, watcher_id: 'luis' }, { cc_company_id: '1461', stage: 'invoiced', owner_id: 'laura', watcher_id: 'jc' }, { cc_company_id: '1461', stage: 'field_complete', owner_id: 'laura', watcher_id: 'jc' }], board: BOARD, queue: QUEUE, clock: CLOCK, pipeline: PIPE, estimates: EST, direct: DIRECT, bills: BILLS.filter((x) => ['landed', 'matched', 'needs_human', 'held', 'wrong_job'].includes(x.status)),
    ...
    sellers: [{ id: 'r1', name: 'Ron Seidel', cc_default_company_id: '1461' }, { id: 'r2', name: 'Travis Janke', cc_default_company_id: '1461' }, { id: 'r3', name: 'Eric Payne', cc_default_company_id: '1461' }, { id: 'r5', name: 'Haakon Endreson', cc_default_company_id: '1461' }, { id: '940ad537-cfbd-4129-a335-9d8a9bc7a013', name: 'Gio Calderin', cc_default_company_id: '1461' }, { id: 'c2b126ae-a182-4dca-be11-2b9bf02c1c21', name: 'Jessica Coley', cc_default_company_id: '1461' }, { id: 'r4', name: 'Mike LeRoy', cc_default_company_id: '1560' }],
...
function leadFile(p) {
  ...
  return { job, customer: { id: p.customer_id, name: p.customers.name, phone: p.customers.phone, email: 'grace.okonkwo@example.com', street: '4050 Palm Ave', city: p.customers.city, state: 'FL', zip: '32754', sms_opt_out_at: null, disposition: null }, texts: [], emails: [], thread: { id: 't' + p.id }, messages,
