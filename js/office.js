...
import { state, isDemo, personName, settleAsk, uploadDoc, setSwitch, offerNextWord, nextWordFor } from './book.js?v=79';
import * as api from './api.js?v=79';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=79';
import { brandName, askLabel, stageLabel, STAGES, BRAND_BY_CC } from './config.js?v=79';
import { iconForAsk } from './words.js?v=79';
import { DEMO_STEPS } from './demo-office.js?v=79';
