...
import { state, isDemo, personName, settleAsk, uploadDoc, setSwitch } from './book.js?v=40';
import * as api from './api.js?v=40';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=40';
import { brandName, askLabel, stageLabel, STAGES, BRAND_BY_CC } from './config.js?v=40';
import { iconForAsk } from './words.js?v=40';
import { DEMO_STEPS } from './demo-office.js?v=40';
