...
import { state, isDemo, personName, settleAsk, uploadDoc, setSwitch } from './book.js?v=23';
import * as api from './api.js?v=23';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=23';
import { brandName, askLabel, stageLabel, STAGES, BRAND_BY_CC } from './config.js?v=23';
import { DEMO_STEPS } from './demo-office.js?v=23';
