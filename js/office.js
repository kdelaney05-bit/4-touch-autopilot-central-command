...
import { state, isDemo, personName, settleAsk, uploadDoc, setSwitch, offerNextWord, nextWordFor } from './book.js?v=84';
import * as api from './api.js?v=84';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=84';
import { brandName, askLabel, stageLabel, STAGES, BRAND_BY_CC } from './config.js?v=84';
import { iconForAsk } from './words.js?v=84';
import { DEMO_STEPS } from './demo-office.js?v=84';
