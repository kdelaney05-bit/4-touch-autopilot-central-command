...
import * as api from './api.js?v=78';
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=78';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=78';
import { BRAND_BY_CC } from './config.js?v=78';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=78';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=78';
import { renderHome } from './home.js?v=78';
import { renderSales } from './sales.js?v=78';
import { renderPipeline } from './pipeline.js?v=78';
import { renderMarketing } from './marketing.js?v=78';
import { renderOffice } from './office.js?v=78';
import { renderProduction } from './production.js?v=78';
import { renderFiles, openFile, closeDrawer } from './file.js?v=78';
import { stopRoomPoll } from './village.js?v=78';
import { renderFlow, stopFlow } from './flow.js?v=78';
import { startTour, tourWanted } from './tour.js?v=78';
import { startAlerts } from './alerts.js?v=78';
import { renderPhotos } from './photos.js?v=78';
