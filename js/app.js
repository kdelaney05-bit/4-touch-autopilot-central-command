...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob, repDay, whoIsFree, personName, firstName } from './book.js?v=127';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=127';
import { BRAND_BY_CC, LEAD_REP_NOTE } from './config.js?v=127';
import { addressPicker, addressSource } from './address.js?v=127';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=127';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=127';
import { renderHome } from './home.js?v=127';
import { renderRoom } from './village.js?v=127';
import { renderSales } from './sales.js?v=127';
import { renderPipeline } from './pipeline.js?v=127';
import { renderMarketing } from './marketing.js?v=127';
import { renderOffice } from './office.js?v=127';
import { renderProduction } from './production.js?v=127';
import { renderFiles, openFile, closeDrawer } from './file.js?v=127';
import { stopRoomPoll } from './village.js?v=127';
import { renderFlow, stopFlow } from './flow.js?v=127';
import { startTour, tourWanted } from './tour.js?v=127';
import { startAlerts } from './alerts.js?v=127';
import { renderPhotos } from './photos.js?v=127';
