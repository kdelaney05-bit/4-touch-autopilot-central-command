...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob, repDay, personName, firstName } from './book.js?v=123';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=123';
import { BRAND_BY_CC, LEAD_REP_NOTE } from './config.js?v=123';
import { addressPicker, addressSource } from './address.js?v=123';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=123';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=123';
import { renderHome } from './home.js?v=123';
import { renderRoom } from './village.js?v=123';
import { renderSales } from './sales.js?v=123';
import { renderPipeline } from './pipeline.js?v=123';
import { renderMarketing } from './marketing.js?v=123';
import { renderOffice } from './office.js?v=123';
import { renderProduction } from './production.js?v=123';
import { renderFiles, openFile, closeDrawer } from './file.js?v=123';
import { stopRoomPoll } from './village.js?v=123';
import { renderFlow, stopFlow } from './flow.js?v=123';
import { startTour, tourWanted } from './tour.js?v=123';
import { startAlerts } from './alerts.js?v=123';
import { renderPhotos } from './photos.js?v=123';
