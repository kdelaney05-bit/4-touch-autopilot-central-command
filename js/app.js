...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=52';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=52';
import { BRAND_BY_CC } from './config.js?v=52';
import { ROOMS_BY_ROLE, ROOM_LABEL } from './config.js?v=52';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=52';
import { renderHome } from './home.js?v=52';
import { renderSales } from './sales.js?v=52';
import { renderPipeline } from './pipeline.js?v=52';
import { renderMarketing } from './marketing.js?v=52';
import { renderOffice } from './office.js?v=52';
import { renderProduction } from './production.js?v=52';
import { renderFiles, openFile, closeDrawer } from './file.js?v=52';
import { stopRoomPoll } from './village.js?v=52';
import { renderFlow, stopFlow } from './flow.js?v=52';
