...
import { state, loadAll, isDemo, searchCustomers, createJob } from './book.js?v=39';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=39';
import { BRAND_BY_CC } from './config.js?v=39';
import { ROOMS_BY_ROLE, ROOM_LABEL } from './config.js?v=39';
import { renderSwitchboard } from './switchboard.js?v=39';
import { renderHome } from './home.js?v=39';
import { renderSales } from './sales.js?v=39';
import { renderPipeline } from './pipeline.js?v=39';
import { renderMarketing } from './marketing.js?v=39';
import { renderOffice } from './office.js?v=39';
import { renderProduction } from './production.js?v=39';
import { renderFiles, openFile, closeDrawer } from './file.js?v=39';
