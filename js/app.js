...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=84';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=84';
import { BRAND_BY_CC } from './config.js?v=84';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=84';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=84';
import { renderHome } from './home.js?v=84';
import { renderRoom } from './village.js?v=84';
import { renderSales } from './sales.js?v=84';
import { renderPipeline } from './pipeline.js?v=84';
import { renderMarketing } from './marketing.js?v=84';
import { renderOffice } from './office.js?v=84';
import { renderProduction } from './production.js?v=84';
import { renderFiles, openFile, closeDrawer } from './file.js?v=84';
import { stopRoomPoll } from './village.js?v=84';
import { renderFlow, stopFlow } from './flow.js?v=84';
import { startTour, tourWanted } from './tour.js?v=84';
import { startAlerts } from './alerts.js?v=84';
import { renderPhotos } from './photos.js?v=84';
