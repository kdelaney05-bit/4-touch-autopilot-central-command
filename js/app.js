...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=96';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=96';
import { BRAND_BY_CC } from './config.js?v=96';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=96';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=96';
import { renderHome } from './home.js?v=96';
import { renderRoom } from './village.js?v=96';
import { renderSales } from './sales.js?v=96';
import { renderPipeline } from './pipeline.js?v=96';
import { renderMarketing } from './marketing.js?v=96';
import { renderOffice } from './office.js?v=96';
import { renderProduction } from './production.js?v=96';
import { renderFiles, openFile, closeDrawer } from './file.js?v=96';
import { stopRoomPoll } from './village.js?v=96';
import { renderFlow, stopFlow } from './flow.js?v=96';
import { startTour, tourWanted } from './tour.js?v=96';
import { startAlerts } from './alerts.js?v=96';
import { renderPhotos } from './photos.js?v=96';
