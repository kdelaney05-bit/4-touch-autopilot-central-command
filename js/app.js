...
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=67';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=67';
import { BRAND_BY_CC } from './config.js?v=67';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=67';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=67';
import { renderHome } from './home.js?v=67';
import { renderSales } from './sales.js?v=67';
import { renderPipeline } from './pipeline.js?v=67';
import { renderMarketing } from './marketing.js?v=67';
import { renderOffice } from './office.js?v=67';
import { renderProduction } from './production.js?v=67';
import { renderFiles, openFile, closeDrawer } from './file.js?v=67';
import { stopRoomPoll } from './village.js?v=67';
import { renderFlow, stopFlow } from './flow.js?v=67';
import { startTour, tourWanted } from './tour.js?v=67';
import { startAlerts } from './alerts.js?v=67';
import { renderPhotos } from './photos.js?v=67';
