...
import * as api from './api.js?v=79';
import { state, loadAll, isDemo, searchCustomers, searchPeople, createJob } from './book.js?v=79';
import { $, $$, html, raw, toast, esc, openModal } from './ui.js?v=79';
import { BRAND_BY_CC } from './config.js?v=79';
import { ROOMS_BY_ROLE, ROOM_LABEL, ROOMS_BY_SEAT, KEYS } from './config.js?v=79';
import { renderSwitchboard, stopLinePoll } from './switchboard.js?v=79';
import { renderHome } from './home.js?v=79';
import { renderSales } from './sales.js?v=79';
import { renderPipeline } from './pipeline.js?v=79';
import { renderMarketing } from './marketing.js?v=79';
import { renderOffice } from './office.js?v=79';
import { renderProduction } from './production.js?v=79';
import { renderFiles, openFile, closeDrawer } from './file.js?v=79';
import { stopRoomPoll } from './village.js?v=79';
import { renderFlow, stopFlow } from './flow.js?v=79';
import { startTour, tourWanted } from './tour.js?v=79';
import { startAlerts } from './alerts.js?v=79';
import { renderPhotos } from './photos.js?v=79';
