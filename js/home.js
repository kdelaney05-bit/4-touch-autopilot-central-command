...
import { state, isDemo, personName, firstName } from './book.js?v=8';
import { html, raw, esc } from './ui.js?v=8';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=8';
