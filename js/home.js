...
import { state, isDemo, personName, firstName } from './book.js?v=36';
import { html, raw, esc } from './ui.js?v=36';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=36';
import { renderRoom } from './village.js?v=36';
