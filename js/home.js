...
import { state, isDemo, personName, firstName } from './book.js?v=27';
import { html, raw, esc } from './ui.js?v=27';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=27';
import { renderRoom } from './village.js?v=27';
