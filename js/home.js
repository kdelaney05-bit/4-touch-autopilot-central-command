...
import { state, isDemo, personName, firstName } from './book.js?v=24';
import { html, raw, esc } from './ui.js?v=24';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=24';
import { renderRoom } from './village.js?v=24';
