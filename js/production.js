...
import { state, isDemo, personName, firstName, takeJob, assignJob, handBack, seatName } from './book.js?v=108';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=108';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=108';
