...
import { state, isDemo, personName, firstName, takeJob, assignJob, handBack, seatName } from './book.js?v=28';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=28';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=28';
import { reload } from './app.js?v=28';
import { renderRoom } from './village.js?v=28';
