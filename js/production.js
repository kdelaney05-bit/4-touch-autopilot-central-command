...
import { state, isDemo, personName, firstName, takeJob, assignJob, handBack, seatName } from './book.js?v=16';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=16';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=16';
import { reload } from './app.js?v=16';
import { renderRoom } from './village.js?v=16';
