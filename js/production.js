...
import { state, isDemo, personName, firstName, takeJob, assignJob, handBack, seatName } from './book.js?v=78';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=78';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=78';
import { reload } from './app.js?v=78';
import { renderRoom } from './village.js?v=78';
