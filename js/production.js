...
import { state, isDemo, personName, firstName, takeJob, assignJob, handBack, seatName } from './book.js?v=77';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=77';
import { STAGES, STAGE_LINE_DAYS, brandName, stageLabel } from './config.js?v=77';
import { reload } from './app.js?v=77';
import { renderRoom } from './village.js?v=77';
