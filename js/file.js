...
import { state, isDemo, personName, firstName, loadFile, textCustomer, cancelText, takeJob, handBack, assignJob, addDoc, adoptJob, postMessage, openAsk, ensureThread, seatName, linePreview, threadForJob, mentionSeen, invoiceRequest, createEstimate, parcelLookup, fillPaperwork, openPaperwork, openPacketFile } from './book.js?v=39';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=39';
import { STAGES, stageLabel, brandName, askLabel, ASK_LABEL } from './config.js?v=39';
import { say, thing, iconForAsk } from './words.js?v=39';
import { settleDialog } from './office.js?v=39';
import { reload } from './app.js?v=39';
import { relTime } from './production.js?v=39';
