...
import { state, isDemo, personName, firstName, loadFile, textCustomer, cancelText, takeJob, handBack, assignJob, addDoc, adoptJob, postMessage, openAsk, ensureThread, seatName, linePreview, threadForJob, mentionSeen, invoiceRequest, createEstimate, parcelLookup, fillPaperwork, openPaperwork, openPacketFile } from './book.js?v=28';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=28';
import { STAGES, stageLabel, brandName, askLabel, ASK_LABEL } from './config.js?v=28';
import { settleDialog } from './office.js?v=28';
import { reload } from './app.js?v=28';
import { relTime } from './production.js?v=28';
