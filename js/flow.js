...
import { state, isDemo, firstName } from './book.js?v=127';
import { $, html, raw, esc } from './ui.js?v=127';
import { brandName } from './config.js?v=127';
...
import { STEPS, STEP_OF, thing, ICON, person, pace, MAP } from './words.js?v=127';
