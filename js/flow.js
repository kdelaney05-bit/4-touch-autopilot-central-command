...
import { state, isDemo, firstName } from './book.js?v=136';
import { $, html, raw, esc } from './ui.js?v=136';
import { brandName } from './config.js?v=136';
...
import { STEPS, STEP_OF, thing, ICON, person, pace, MAP } from './words.js?v=136';
...
function paint(root) {
  ...
  root.innerHTML = html`
    <div class="head">
      <div data-tour="flow-head"><div class="kicker">The job board · every sold job, where it is, what moved · refreshed ${at.toLocaleTimeString([], { hour: 'numeric', minute: '2-digit' })}</div>
