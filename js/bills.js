...
import { state, isDemo, firstName, personName, seatName, decideBill, rematchBill, openBillPdf, searchCustomers } from './book.js?v=134';
import { invoiceCard, invoiceNext, wireInvoice } from './invoice.js?v=134';   // 381: the customer's invoice, from the sign-off to the money
import { raw, esc, toast, openModal } from './ui.js?v=134';
