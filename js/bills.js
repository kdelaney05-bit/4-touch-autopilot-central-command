...
import { state, isDemo, firstName, personName, seatName, decideBill, rematchBill, openBillPdf, searchCustomers } from './book.js?v=105';
import { invoiceCard, invoiceNext, wireInvoice } from './invoice.js?v=105';   // 381: the customer's invoice, from the sign-off to the money
import { raw, esc, toast, openModal } from './ui.js?v=105';
