...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=108';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=108';
import { brandName } from './config.js?v=108';
import { micButton } from './dictate.js?v=108';   // 388: dictate the nugget in the crew's language
