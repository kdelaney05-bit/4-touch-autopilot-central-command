...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=143';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=143';
import { brandName } from './config.js?v=143';
import { micButton } from './dictate.js?v=143';   // 388: dictate the nugget in the crew's language
