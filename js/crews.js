...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=131';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=131';
import { brandName } from './config.js?v=131';
import { micButton } from './dictate.js?v=131';   // 388: dictate the nugget in the crew's language
