...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=147';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=147';
import { brandName } from './config.js?v=147';
import { micButton } from './dictate.js?v=147';   // 388: dictate the nugget in the crew's language
