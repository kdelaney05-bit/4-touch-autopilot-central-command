...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=113';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=113';
import { brandName } from './config.js?v=113';
import { micButton } from './dictate.js?v=113';   // 388: dictate the nugget in the crew's language
