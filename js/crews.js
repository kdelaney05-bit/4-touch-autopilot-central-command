...
import { state, isDemo, personName, firstName, photoSrc, upsertCrew, sendNugget, searchCustomers } from './book.js?v=146';
import { $, html, raw, esc, toast, openModal } from './ui.js?v=146';
import { brandName } from './config.js?v=146';
import { micButton } from './dictate.js?v=146';   // 388: dictate the nugget in the crew's language
