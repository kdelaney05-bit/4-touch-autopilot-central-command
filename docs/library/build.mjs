...
const SPEC_FILM = {
  'tag-the-office': 'ride-along-tag-the-office',
...
const KNOWN = {
  'ride-along-tag-the-office': { where: ['cc', 'app'], short: 'A true story from this week: a customer told to call the office, four calls, the machine every time. The same week the new way: the rep types @office on the customer\'s file, the office answers on the file and texts the customer from it. Nobody calls anybody.', ask: ['A customer texts me that their HOA or permit is approved, what do I do?', 'Should I tell a customer to call the office?', 'How does the office find out something a customer told me?', 'How do I get a customer scheduled without a phone call?'] },
