...
| 4 | Kevin | The QuickBooks consent. **Done — three companies, and that is all of them.** Liberty Fencing, Pro-Tech, Oasis are connected on live. Liberty Roofing (1537) has no file of its own: it lives inside Pro-Tech's QuickBooks company (022), and `qb-bills.mjs` routes it there (16 Sep late). | nothing |
